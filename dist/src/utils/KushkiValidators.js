...
const KushkiError_1 = require("./KushkiError");
/**
 * KushkiValidators check valid schema for all classes.
 * @class PaymentReceipt
 */
class KushkiValidators {
    ...
    validate() {
        ...
        const schema = JSON.parse(fs.readFileSync(path.resolve(`${__dirname}/../../models/${this.schemaFile}.json`), 'utf8'));
        const ajv = new Ajv();
...
exports.KushkiValidators = KushkiValidators;
